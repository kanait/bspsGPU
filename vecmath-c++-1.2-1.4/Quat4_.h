...
class Quat4 : public Tuple4<T> {
 ...
 public:
   ...
   */
  void conjugate() {
    Tuple4<T>::x = -Tuple4<T>::x;
    Tuple4<T>::y = -Tuple4<T>::y;
    Tuple4<T>::z = -Tuple4<T>::z;
  }
 ...
 protected:
  T norm() const {
    return ( Tuple4<T>::x*Tuple4<T>::x +
             Tuple4<T>::y*Tuple4<T>::y +
             Tuple4<T>::z*Tuple4<T>::z +
             Tuple4<T>::w*Tuple4<T>::w );
  }
 ...
 public:
  ...
  void inverse() {
    T n = norm();
    // zero-div may occur.
    Tuple4<T>::x = -Tuple4<T>::x/n;
    Tuple4<T>::y = -Tuple4<T>::y/n;
    Tuple4<T>::z = -Tuple4<T>::z/n;
    Tuple4<T>::w /= n;
  }
  ...
  void set(AxisAngle4f a1) {
    ...
    Tuple4<T>::y = a1.y;
    Tuple4<T>::z = a1.z;
    T n = Math.sqrt(Tuple4<T>::x*Tuple4<T>::x + Tuple4<T>::y*Tuple4<T>::y + Tuple4<T>::z*Tuple4<T>::z);
    // zero-div may occur.
    T s = Math.sin(0.5*a1.angle)/n;
    Tuple4<T>::x *= s;
    Tuple4<T>::y *= s;
    Tuple4<T>::z *= s;
    Tuple4<T>::w = Math.cos(0.5*a1.angle);
  }
