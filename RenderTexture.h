...
public:
  ...
  void draw_quad() {
    glBegin( GL_QUADS );
    glTexCoord2f(0, 0); 
    glMultiTexCoord2fARB(GL_TEXTURE1_ARB, 0, 0);                    glVertex2f(-1, -1);
    glTexCoord2f(GetWidth(), 0); 
    glMultiTexCoord2fARB(GL_TEXTURE1_ARB, GetWidth(), 0);           glVertex2f(1, -1);
    glTexCoord2f(GetWidth(), GetHeight()); 
    glMultiTexCoord2fARB(GL_TEXTURE1_ARB, GetWidth(), GetHeight()); glVertex2f(1, 1);
    glTexCoord2f(0, GetHeight()); 
    glMultiTexCoord2fARB(GL_TEXTURE1_ARB, 0, GetHeight());          glVertex2f(-1, 1);
    glEnd();
  };
